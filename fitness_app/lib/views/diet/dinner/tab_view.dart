...
class DinnerTabView extends ConsumerStatefulWidget {
  const DinnerTabView({super.key, required this.date});

  final DateTime date;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() {
    return _DinnerTabViewState();
  }
}

class _DinnerTabViewState extends ConsumerState<DinnerTabView> {
  final UserAuth _userAuth = UserAuth();

  @override
  Widget build(BuildContext context) {
    final item = ref.watch(dinnerItemStreamProvider(
        DinnerItemEquatable(id: _userAuth.getUserId(), date: widget.date)));
